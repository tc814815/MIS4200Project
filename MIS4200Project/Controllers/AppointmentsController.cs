...
namespace MIS4200Project.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "appointmentID,appointmentDate,apoointmentDescription,patietntD,doctorID")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "appointmentID,appointmentDate,apoointmentDescription,patietntD,doctorID")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
